...
package com.mycompany.array_data;
...
public class Array_Data {
    ...
    public static void main(String[] args) {
        ...
        String firstname, lastname, email, key, ident_number = null;
        int age, opt;
                ...
                case 1:
                    ...
                    while(id_exists){
                        ...
                        if(identNumbers.contains(ident_number)){
                            System.out.println("This identification number already exists. Please try again.");
                        }else{
                            id_exists = false;
                        }
                    }
